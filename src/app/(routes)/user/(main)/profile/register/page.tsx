    ...
    <>
      <div className='flex justify-center h-screen items-start'>
        <div className='flex flex-col align-center items-center gap-[56px] sm:w-[375px] md:w-[744px] lg:w-[1400px] p-[24px] pb-[40px]'>
          <div className='flex flex-col gap-2 items-center sm:gap-[16px] xl:gap-[64px] xl:w-[1352px] '>
            <div className='flex flex-col sm:gap-[16px] xl:gap-[32px] w-full sm:max-w-[327px] xl:max-w-[640px]'>
              ...
              <div className='text-xs xl:text-xl font-regular text-black-200 '>
            ...
            >
              <div className='flex flex-col gap-3 sm:gap-5 xl:gap-8 w-full sm:max-w-[327px] xl:max-w-[640px]'>
                {/* 이미지 업로더 */}
                ...
                <div className='flex flex-col gap-2'>
                  ...
                  <div className='text-xs xl:text-lg font-regular text-gray-400'>
                    *이용 서비스는 중복 선택 가능해요!
                  </div>
                </div>
                <BtGrid
              ...
              <CommonButton
                ...
                type='submit'
                className={`w-full sm:h-[54px] xl:w-[640px] xl:h-[64px] ${
                  isValid
