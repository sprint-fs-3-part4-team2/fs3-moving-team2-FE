...
export default function RatingStat({
  ...
  return (
    <div className='flex flex-col gap-[32px]'>
      ...
      <div className='flex flex-col md:flex-row xl:flex-row gap-[40px] md:gap-[56px] xl:gap-[56px] items-center xl:bg-backgroundVariants-200 xl:py-[40px] justify-center rounded-[32px]'>
